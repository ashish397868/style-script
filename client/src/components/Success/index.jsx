      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-16">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-center">
            ...
            <p className="text-indigo-100 text-lg max-w-2xl mx-auto">Thank you for your purchase. Your order has been placed and is being processed.</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/" className="flex-1 text-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 font-medium">
                Continue Shopping
              </Link>
              <Link to="/orders" className="flex-1 text-center px-6 py-3 bg-white border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 font-medium">
                View Order Details
              </Link>
            </div>
          </div>
