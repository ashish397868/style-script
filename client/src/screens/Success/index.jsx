    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-16">
          <div className="bg-gradient-to-r from-pink-600 to-purple-600 p-8 text-center">
            ...
            <p className="text-pink-100 text-lg max-w-2xl mx-auto">Thank you for your purchase. Your order has been placed and is being processed.</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-lg font-bold text-pink-600">{_id}</p>
                </div>
                <div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="bg-pink-100 text-pink-600 rounded-full p-2 mr-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/" className="flex-1 text-center px-6 py-3 bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-lg hover:from-pink-700 hover:to-purple-700 font-medium">
                Continue Shopping
              </Link>
              <Link to="/orders" className="flex-1 text-center px-6 py-3 bg-white border border-pink-600 text-pink-600 rounded-lg hover:bg-pink-50 font-medium">
                View Order Details
              </Link>
            </div>
          </div>
      ...
      <div className="w-full mt-16">
        <div className="max-w-6xl mx-auto px-4">
          <RelatedProducts categories={products.map((p) => p.category)} excludeIds={products.map((p) => p._id)} />
        </div>
      </div>
    </div>
  );
