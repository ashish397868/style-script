...
const Footer = ({ shopLinks = [], customerLinks = [], policyLinks = [] }) => {
  return (
    <footer className="bg-[#f6f9fc] text-gray-700 text-sm px-6 py-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          <div className="flex items-center space-x-2 mb-2">
            <img src="https://www.svgrepo.com/show/42638/clothes.svg" alt="Logo" className="w-8 h-8" />
            <h2 className="text-lg font-bold text-pink-600">StyleScript</h2>
          </div>
          <p>Wear the &lt;code/&gt;</p>
      ...
      <div className="text-center text-gray-500 mt-10 text-xs">
        © 2025 StyleScript.com — All Rights Reserved
      </div>
    </footer>
  );
};
