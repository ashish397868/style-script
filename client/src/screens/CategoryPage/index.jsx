        ...
        {products && products.length > 0 ? (
          ...
          <div className="text-center py-8">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-xl text-gray-700 mb-4">No {category.toLowerCase()} available at the moment.</p>
              <p className="text-gray-600 mb-6">Please check back later for new arrivals.</p>
